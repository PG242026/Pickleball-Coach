...
.container>.card:first-of-type{padding:0!important;border-radius:10px!important;margin-bottom:14px!important}.container>.card:first-of-type .beheer-summary{min-height:46px!important;margin:0!important;padding:4px 14px!important;font-size:21px!important;line-height:1.2!important}.container>.card:first-of-type .accordion-chevron{flex-basis:34px!important;width:34px!important;height:34px!important;margin-left:10px!important}.container>.card:first-of-type .accordion-chevron::before{width:14px!important;height:14px!important;border-right-width:3px!important;border-bottom-width:3px!important}.container>.card:first-of-type details[open] .beheer-summary{border-bottom:1px solid #e4eee8}.container>.card:first-of-type details>div{padding:10px 14px 12px!important;margin-top:0!important}.container>.card:first-of-type input{padding:9px 11px!important;margin-top:5px!important;margin-bottom:8px!important;font-size:16px!important}.container>.card:first-of-type button{min-height:38px!important;padding:8px 12px!important;font-size:15px!important}.container>.card:first-of-type .speler-item{padding:8px 10px!important;margin-bottom:7px!important}
...
(function(){
  ...
  function initPlayerScrub(){
    ...
    function update(){
      ...
      duration.textContent=formatTime(length); current.textContent=formatTime(now); slider.disabled=!length;
