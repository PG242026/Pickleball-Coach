const CACHE_NAME = 'pickleball-coach-ai-v49';
const AI_CLIENT_SCRIPT = '<script src="/ai-backend-client.js?v=cache49"></script>';
...
(function(){
  function fixYoutubeComparePanel(){
    ...
    if(analysis&&compare){
      analysis.classList.remove('player-analysis-outside');
